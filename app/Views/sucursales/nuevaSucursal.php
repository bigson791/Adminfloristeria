<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <?php } ?>
            <div class="card mb-4">
                <form method="post" action="<?php echo base_url(); ?>insertarSucursal" autocomplete="off">
                    <?php csrf_field(); ?>
                    <div class="form-group">
                        ...
                        <div class="row" style="padding-left: 20px; padding-top: 20px; padding-right: 20px;">
                            <div class="col-12 col-sm-6">
                                ...
                                <input class="form-control" id="telefono" name="telefono" type="tel" value="<?php echo set_value('telefono'); ?>">
                            </div>
                            <div class="col-12 col-sm-6">
                                <label>Empresa:</label>
                                <select class="form-control form-select" id="empresa" name="empresa" required>
                                    ...
                                    <?php foreach ($empresas as $empresa) { ?>
                                        <option value="<?php echo $empresa['emp_id']; ?>" <?php if ($empresa['emp_id'] == '1') {
                                                                                            echo 'selected';
