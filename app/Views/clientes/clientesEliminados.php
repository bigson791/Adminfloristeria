        ...
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                <div class="table-responsive" style="padding-left: 20px; padding-top: 20px; padding-right: 20px;">
                    <table class="table-sm display dataTable dtr-inline collapsed" id="tablaClientes">
                        <thead>
                            <th>Nombres</th>
                            <th>Apellidos</th>
                            <th>Nit</th>
                        ...
                        <tbody>
                            <?php foreach ($Clientes as $dato) { ?>
                                <tr>
                                    ...
                                    <td><a href="#" data-href="<?php echo base_url() . 'reingresarCliente/' . $dato['cl_id'] ?>" class="btn btn-primary btn-EliminarCliente" title="Regresar Registro"> <i class="fa-solid fa-turn-up"></i></a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
