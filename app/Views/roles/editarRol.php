<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <?php } ?>
            <div class="card mb-4">
                <form method="post" action="<?php echo base_url(); ?>actualizarRol" autocomplete="off">
                    <?php csrf_field(); ?>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <label hidden>Código Rol:</label>
                                <input class="form-control" id="codigoRol" name="codigoRol" type="text" required value="<?php echo  $datos['rl_id'];  ?>" hidden>
                            </div>
                        </div>
                        <div class="row" style="padding-left: 20px; padding-top: 20px; padding-right: 20px;">
                            <div class="col-12 col-sm-12">
                                <label>Nombre Rol:</label>
                                <input class="form-control" id="nombre" name="nombre" type="text" autofocus required value="<?php echo  $datos['rl_nombre'];  ?>">
                            </div>
                        </div>
