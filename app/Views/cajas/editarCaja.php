<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <?php } ?>
            <div class="card mb-4">
                <form method="post" action="<?php echo base_url(); ?>actualizarCaja" autocomplete="off">
                    <?php csrf_field(); ?>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <label hidden>Código Sucursal:</label>
                                <input class="form-control" id="codigoSucursal" name="codigoCaja" type="text" required value="<?php echo  $datos['cj_id'];  ?>" hidden>
                            </div>
                        </div>
                        <div class="row" style="padding-left: 20px; padding-top: 20px; padding-right: 20px;">
                            <div class="col-12 col-sm-6">
                                <label>Nombre Caja:</label>
                                <input class="form-control" id="nombre" name="nombre" type="text" autofocus required value="<?php echo  $datos['cj_nombre'];  ?>">
                            </div>
                            <div class="col-12 col-sm-6">
                                <label>Número Caja:</label>
                                <input class="form-control" id="numeroCaja" name="numeroCaja" type="text" value="<?php echo  $datos['cj_num_caja']; ?>">
                            </div>
                        </div>
                        <div class="row" style="padding-left: 20px; padding-top: 20px; padding-right: 20px;">
                            <div class="col-12 col-sm-6">
                                <label>Folio:</label>
                                <input class="form-control" id="folio" name="folio" type="text" value="<?php echo $datos['cj_folio']; ?>">
                            </div>
                        </div>
