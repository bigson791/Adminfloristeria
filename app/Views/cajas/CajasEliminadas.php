                        ...
                        <tbody>
                            <?php foreach ($Cajas as $dato) { ?>
                                ...
                                <td><?php echo $dato['cj_num_caja']; ?></td>
                                    ...
                                    <td><a href="#" data-href="<?php echo base_url() . 'reingresarCaja/' . $dato['cj_id'] ?>" class="btn btn-primary btn-Eliminar" title="Reingresar registro"> <i class="fa-solid fa-turn-up"></i></a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
