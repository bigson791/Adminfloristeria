<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <?php } ?>
            <div class="card mb-4">
                <form method="post" action="<?php echo base_url(); ?>insertarCaja" autocomplete="off">
                    <?php csrf_field(); ?>
                    <div class="form-group">
                        <div class="row" style="padding-left: 20px; padding-top: 20px; padding-right: 20px;">
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <input class="form-control" id="numeroCaja" name="numeroCaja" type="text" value="<?php echo set_value('numeroCaja'); ?>">
                            </div>
                        </div>
                        <div class="row" style="padding-left: 20px; padding-top: 20px; padding-right: 20px;">
                            <div class="col-12 col-sm-6">
                                <label>Folio:</label>
                                <input class="form-control" id="folio" name="folio" type="tel" value="<?php echo set_value('numeroCaja'); ?>">
                            </div>
                        </div>
                        <div class="text-center" style="padding-top: 20px;padding-bottom: 20px;">
                            <a class="btn btn-primary" style="color: white;" href="<?php echo base_url() ?>cajas"> <i class="fa-solid fa-rotate-left"></i> Regresar</a>
