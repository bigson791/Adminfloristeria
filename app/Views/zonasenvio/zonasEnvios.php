<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <div>
                <p>
                    <a href="<?php echo base_url() ?>nuevaZonaEnvio" class="btn btn-info" style="color: white;"> <i class="fa-solid fa-plus"></i> Agregar Zona</a>
                    <a href="<?php echo base_url() ?>zonasEnviosEliminadas" class="btn btn-danger"> <i class="fa-regular fa-eye"></i> Ver Eliminados</a>
                </p>
            </div>
            <div class="card mb-4">
                        ...
                        <tbody>
                            <?php foreach ($zonasenvio as $dato) { ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url() . 'editarZonaEnvio/' . $dato['env_id'] ?>" class="btn btn-warning " title="Editar Empresa"> <i class="fa-solid fa-pen"></i></a></td>
                                    <td><a id="eliminarCliente" href="#" data-href="<?php echo base_url() . 'eliminarZonaEnvio/' . $dato['env_id'] ?>" class="btn btn-danger btn-EliminarCliente" title="Eliminar Empresa"><i class="fa-solid fa-trash"></i></a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
