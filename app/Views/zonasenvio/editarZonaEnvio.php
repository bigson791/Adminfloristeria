<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <?php } ?>
            <div class="card mb-4">
                <form method="post" action="<?php echo base_url(); ?>actualizarZonaEnvio" autocomplete="off">
                    <?php csrf_field(); ?>
                    <div class="form-group">
                        <div class="row" style="padding-left: 20px; padding-top: 20px; padding-right: 20px;">

                            <label hidden>Código Zona:</label>
                            <input class="form-control" id="codigoZona" name="codigoZona" type="tecodigoZonaxt" value="<?php echo $data['env_id']; ?>" hidden>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <select class="form-control form-select" id="departamentos" name="departamentos" required>
                                    ...
                                    <?php foreach ($departamentos as $departamento) { ?>
                                        <option value="<?php echo $departamento['dep_id']; ?>" <?php if ($departamento['dep_id'] == $data['env_dep']) {
                                                                                                    echo 'selected';
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <select name="municipios" id="municipios" class="form-control form-select" required>
                                    ...
                                    <?php foreach ($municipios as $municipio) { ?>
                                        <option value="<?php echo $municipio['mun_id']; ?>" <?php if ($municipio['mun_id'] == $data['env_muni']) {
                                                                                                echo 'selected';
                                                                                            } ?>><?php echo $municipio['mun_nombre'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        <div class="row" style="padding-left: 20px; padding-top: 20px; padding-right: 20px;">
                            <div class="col-6 col-sm-6">
                                <label>Zona:</label>
                                <input class="form-control" id="zona" name="zona" type="text" required value="<?php echo $data['env_zona']; ?>">
                            </div>
                            <div class="col-6 col-sm-6">
                                <label>Nombre Zona:</label>
                                <input class="form-control" id="nomZona" name="nomZona" type="text" value="<?php echo $data['env_nombre']; ?>" required>
                            </div>
                            <div class="col-6 col-sm-6">
                                <label>Costo Envío:</label>
                                <input class="form-control" id="costoEnvio" name="costoEnvio" type="text" required value="<?php echo $data['env_precio']; ?>">
                            </div>
                            <div class="col-6 col-sm-6">
                                <label>Ruta:</label>
                                <input class="form-control" id="ruta" name="ruta" type="text" value="<?php echo $data['env_ruta']; ?>">
                            </div>
                        </div>
