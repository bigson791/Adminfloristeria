                        ...
                        <tbody>
                            <?php foreach ($empresas as $dato) { ?>
                                <tr>
                                    ...
                                    <td><a href="#" data-href="<?php echo base_url() . 'reingresarEmpresa/' . $dato['emp_id'] ?>" class="btn btn-primary btn-Eliminar" title="Reingresar Empresa"> <i class="fa-solid fa-turn-up"></i></a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
